...
void Threshold()
{
    ...
    // Plot Data
    std::string path = "plotting_scripts/root_input/results_threshold_scan_W12R1_THR60.root";
    ...
    path = "Plots/local_0048/Threshold/histos.root";
    ...
    TDirectory *dir = (TDirectory*)simuThresholdFile->Get("Thr967");
    ...
    c3->cd();
    h2DSimuThreshold->SetMinimum(720);
    h2DSimuThreshold->SetMaximum(1190);
